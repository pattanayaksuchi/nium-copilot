...
export function ChatInterface() {
    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-subtle">
        <div className="text-center max-w-lg mx-auto p-8">
          <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 flex items-center justify-center shadow-custom-lg">
  ...
  return (
    <div className="flex-1 flex flex-col bg-surface">
      ...
      {/* Message Composer */}
      <div className="border-t border-subtle bg-surface p-4 shadow-sm">
          ...
          <div className="flex gap-3 items-end">
            <div className="flex-1 relative">
              <textarea
                ...
                className="w-full px-4 py-3 pr-12 bg-surface border border-subtle rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-custom placeholder-text-subtle"
                rows={1}
                style={{
                  minHeight: '48px',
                  maxHeight: '120px'
            ...
            <button
              ...
              className="p-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-400 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
            >
